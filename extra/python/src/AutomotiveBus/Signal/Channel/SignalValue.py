...
class SignalValue(object):
    ...
    @classmethod
    def GetRootAsSignalValue(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def SignalValueBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
