...
class MetaFrame(object):
    ...
    def Frame(self):
        ...
        if o != 0:
            ...
            from AutomotiveBus.Register.Ethernet.Frame import Frame
            obj = Frame()
    ...
    def Timing(self):
        ...
        if o != 0:
            x = o + self._tab.Pos
            from AutomotiveBus.Register.Ethernet.MessageTiming import MessageTiming
            obj = MessageTiming()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
def AddFrame(builder, frame): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(frame), 0)
def MetaFrameAddFrame(builder, frame):
    """This method is deprecated. Please switch to AddFrame."""
    return AddFrame(builder, frame)
def AddTiming(builder, timing): builder.PrependStructSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(timing), 0)
