...
class SignalRead(object):
    ...
    @classmethod
    def GetRootAsSignalRead(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def SignalReadBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
